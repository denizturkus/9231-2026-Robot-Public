...
public class TunerConstants {
    ...
    // TODO: Characterize real slip current on carpet
    ...
    .withCurrentLimits(
        new CurrentLimitsConfigs().withStatorCurrentLimit(65).withStatorCurrentLimitEnable(true)
    );
    ...
    // TODO: Re-characterize max drive speed at 12V
    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.04); // 5.04 (theoretical)
