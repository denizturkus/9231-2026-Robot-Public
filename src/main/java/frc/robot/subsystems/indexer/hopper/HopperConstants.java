...
public final class HopperConstants {
    ...
    // TODO: Verify hopper motor CAN ID and CAN bus assignment.
    public static final int kMotorId = 11;
    public static final String kCANBus = "";

    // TODO: Verify hopper motor inversion and neutral behavior on the new robot.
    // Motor config
    ...
    // TODO: Verify hopper feed/reverse voltages on the new robot.
    ...
    // TODO: Revisit status signal rates only if CAN utilization changes.
    // Telemetry / logging
    public static final double kStatusSignalFrequencyHz = 50.0;

    // TODO: Revisit protection thresholds if the motor or mechanism differs.
    // protection
