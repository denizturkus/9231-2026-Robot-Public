// slightly modified from 6328 Mechanical Advantage's PhoenixUtil
...
public final class PhoenixUtil {
	...
	/** Helper method to apply the given configuration to the specified TalonFX motor with retry logic. */
	public static void applyConfigWithRetry(TalonFX talon, TalonFXConfiguration config, int maxAttempts) {
	...
	System.out.println("Failed to apply config after " + maxAttempts + " attempts: " + status);
}
